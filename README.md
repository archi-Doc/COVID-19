...
政府の行動は後追い。「最も国民から反対されない行動」を取っているに過ぎない。
...
Rtには様々な因子が絡んでくるが、今のところ我々はかなり低い数字を維持することに成功している。少なくとも倍々ゲームにはなっていない。

逆に言うと、対策を怠ったり環境が変わったりすると、容易にRtが上昇し、爆発的に感染者数が増える可能性がある。

COVID-19は飛沫感染・接触感染と考えられているので、
