...
SARSと異なるのは、軽症者・無症候性感染者がいること。そして、おそらく無症候性感染者からも感染連鎖している。そうでなければ、日本でのリンクの追えない感染の説明や、欧米での爆発的な感染の説明がつかない。
...
見えない感染連鎖が多い。COVID-19では軽症者が多く、重症者は氷山の一角。同様に、把握できている感染者も氷山の一角だろう（無症候の人、感染連鎖とは無縁の人には検査行わない）。
...
指数関数的に感染者が増加している。正確な感染者数の補足は不可能。死者数からの推測か、定点観測に切り替えるべき。
...
今までの病原体とは異なり、根本的に対処が異なる、封じ込めは不可能だと考えるべき。
...
ウイルスの感染から逃れる、COVID-19を永久に封じ込めるということを勝利とすると、我々の敗北はすでに決まっている。